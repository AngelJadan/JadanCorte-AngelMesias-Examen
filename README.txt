...
a persistence unit "JadanCorte-AngelMesias-ExamenPersistenceUnit" which uses the JakartaEE default database.
...
In case you don't want to use JSF, simply delete this file and "src/main/webapp/beans.xml" and "src/main/java/org/jboss/tools/example/html5/JadanCorte_AngelMesias_Examen/Jsf23Activator.java"
==========================

Testing:
This sample is prepared for running unit tests with the Arquillian framework.

The configuration can be found in "JadanCorte-AngelMesias-Examen/pom.xml":
...
artifact ("JadanCorte-AngelMesias-Examen.war") is already built. You can build
